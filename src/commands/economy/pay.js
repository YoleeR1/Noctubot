...
module.exports = async (client, interaction, args) => {
    ...
    let amount = parseCurrency(interaction.options.getString('amount'));
    
    if (amount <= 0) return client.errNormal({ error: `You can't pay zero or negative money!`, type: 'editreply' }, interaction);
